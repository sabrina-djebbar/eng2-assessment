...
/**
 * This is the item provider adapter for a {@link Y3889274.Microservice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MicroserviceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Y3889274Package.Literals.MICROSERVICE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Y3889274Package.Literals.MICROSERVICE__ENDPOINTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Microservice.class)) {
			case Y3889274Package.MICROSERVICE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Y3889274Package.MICROSERVICE__ENDPOINTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Y3889274Package.Literals.MICROSERVICE__ENDPOINTS,
				 Y3889274Factory.eINSTANCE.createEndpoint()));
	}
