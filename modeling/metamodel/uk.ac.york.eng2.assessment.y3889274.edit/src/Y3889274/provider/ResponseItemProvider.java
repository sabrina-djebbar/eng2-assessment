...
/**
 * This is the item provider adapter for a {@link Y3889274.Response} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResponseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Response_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Response_name_feature", "_UI_Response_type"),
				 Y3889274Package.Literals.RESPONSE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Y3889274Package.Literals.RESPONSE__STATUS_CODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Y3889274Package.Literals.RESPONSE__BODY);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Response.class)) {
			case Y3889274Package.RESPONSE__NAME:
			case Y3889274Package.RESPONSE__STATUS_CODE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Y3889274Package.RESPONSE__BODY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Y3889274Package.Literals.RESPONSE__BODY,
				 Y3889274Factory.eINSTANCE.createField()));
	}
