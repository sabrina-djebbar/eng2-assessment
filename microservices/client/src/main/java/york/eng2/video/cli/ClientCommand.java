...
import york.eng2.video.cli.videos.GetVideosByTagCommand;
import york.eng2.video.cli.videos.GetVideosByUserCommand;
...
@Command(name = "client", description = "...", mixinStandardHelpOptions = true, subcommands = { GetVideosCommand.class,
		AddVideoCommand.class, GetVideoCommand.class, GetVideosByTagCommand.class, GetVideosByUserCommand.class,
		WatchVideoCommand.class, LikeVideoCommand.class, DislikeVideoCommand.class, AddUserCommand.class,
		GetUserCommand.class, GetUsersCommand.class, DeleteUserCommand.class, UpdateUserCommand.class })
